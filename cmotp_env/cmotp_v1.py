...
class CMOTP(gym.Env):
    """ Cooperative multi-agent transporation problem. Centralised version"""
    ...
    def __init__(self, version=1, cooperation_level=0.0):
        ...
        self.observation_space = gym.spaces.Box(low=0, high=3, dtype=np.uint8, shape=self.c.DIM)
    ...
    def step(self, actions):
        ...
        return observations, rewards[0], self.terminal(), dict()
    ...
    def getObservations(self):
        '''
        Returns a single observation for centralised learning
        '''
        return self.getNoisyState()
